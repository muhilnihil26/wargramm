...
const PRIVACY = `WarGram stores: your email, password hash, profile data you provide (username, bio, avatar, phone if added), posts/reels/stories you create, messages you send, follow relationships, and coin balances. We use Lovable Cloud for hosting and Supabase as the database provider. We do NOT sell your data. You may request deletion at any time by contacting support — your account, posts, reels, stories, and messages will be removed. Cookies and localStorage are used for session persistence and theme preference. Calls are peer-to-peer (WebRTC) and not recorded.`;
